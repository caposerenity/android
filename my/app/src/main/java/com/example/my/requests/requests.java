...
//                .show();
    ...
    public static void register(String name,String phone,String password){
        ...
        RxHttp.postJson("http://3s784625n5.qicp.vip:80/api/user/register")
    ...
    public static void login(String phone,String password){
        ...
        RxHttp.postJson("http://3s784625n5.qicp.vip:80/api/user/login")
                .addAll(String.valueOf(json))
                .asString()
                .observeOn(AndroidSchedulers.mainThread()) //指定在主线程回调
                .subscribe(res -> {
    ...
    public static void changePos(String phone,String newPos){
        ...
        //return testconnect.postRequest("http://3s784625n5.qicp.vip:80/api/user/changePos",requestBody);
    ...
    public static void filterPosition(String position){
        //testconnect.getRequest("http://3s784625n5.qicp.vip:80/api/user"+position+"/filterPosition");
        RxHttp.get("http://3s784625n5.qicp.vip:80/api/user"+position+"/filterPosition")
                .asList(String.class)
                .subscribe(res->{
                    if(res.size()!=0){
    ...
    public static void changePassword(String user_id,String phone,String password,String newPassword){
        ...
        //RequestBody requestBody =RequestBody.create(JSON, String.valueOf(json));
        //testconnect.postRequest("http://3s784625n5.qicp.vip:80/api/user/changePassword",requestBody);
        RxHttp.postJson("http://3s784625n5.qicp.vip:80/api/user/changePassword")
                .addAll(String.valueOf(json))
                .asString()
                .observeOn(AndroidSchedulers.mainThread()) //指定在主线程回调
                .subscribe(res -> {
    ...
    public static void changeInfo(String user_id,String phone,String name){
        ...
        //RequestBody requestBody =RequestBody.create(JSON, String.valueOf(json));
        //testconnect.postRequest("http://3s784625n5.qicp.vip:80/api/user/changeInfo",requestBody);
        RxHttp.postJson("http://3s784625n5.qicp.vip:80/api/user/changeInfo")
                .addAll(String.valueOf(json))
                .asString()
                .observeOn(AndroidSchedulers.mainThread()) //指定在主线程回调
                .subscribe(res -> {
    ...
    public static void addtask(String task_name,String expected_time,String expected_exam_time,
        ...
        //RequestBody requestBody =RequestBody.create(JSON, String.valueOf(json));
        //testconnect.postRequest("http://3s784625n5.qicp.vip:80/api/task/addtask",requestBody);
    ...
    public static void getTasks(String user_id){
        testconnect.getRequest("http://3s784625n5.qicp.vip:80/api/task"+user_id+"/getTasks");
    }
    ...
    public static void getAllTasks() {
        ...
        //return testconnect.getRequest("http://3s784625n5.qicp.vip:80/api/user/getAllTasks");
    }

    //@interface 筛选出对应状态的任务
    public static String getTasksByStatus(String status){
        return testconnect.getRequest("http://3s784625n5.qicp.vip:80/api/task"+status+"/getTasksByStatus");
    }
}
